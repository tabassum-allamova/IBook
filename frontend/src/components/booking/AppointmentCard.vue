...
<template>
  <div class="bg-white rounded-xl shadow-sm border border-ibook-brown-100 p-4">
    ...
    <div class="flex items-center justify-between">
      ...
      <!-- Leave Review button (COMPLETED, customer only, no existing review) -->
      <RouterLink
        v-if="
        ...
        class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold rounded-lg border border-ibook-brown-300 text-ibook-brown-700 hover:bg-ibook-brown-50 transition-colors"
      >
        <svg class="h-3.5 w-3.5 text-ibook-gold-400 fill-current" viewBox="0 0 20 20">
